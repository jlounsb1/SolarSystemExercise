...
const solarSystem = [
    ...
    let satellitesSum= Number(system.jupiter.satellites) + Number(system.saturn.satellites) + Number(system.uranus.satellites) + Number(system.neptune.satellites);

    console.log(satellitesSum)

    // for(const sat in system) {
      
    //     if(system[sat].name === "Jupiter" || "Saturn" ||"Uranus" || "Neptune") {
    //     console.log(system[sat].name, system[sat].satellites)
    //     }
    // }
    ...
    let jupMom = system.jupiter.velocity * system.jupiter.mass;
    let plutoMom = system.pluto.velocity * system.pluto.mass
    console.log(jupMom, plutoMom)

    let diff = jupMom - plutoMom;
    console.log(diff)